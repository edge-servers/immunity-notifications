...
from immunity_notifications.migrations import get_swapped_model
...
def create_notification_setting_groups_permissions(apps, schema_editor):
    ...
    app_config = apps.get_app_config('immunity_notifications')
    ...
    permissions = [
        Permission.objects.get(
            content_type__app_label='immunity_notifications',
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('immunity_notifications', '0003_notification_notification_type'),
    ]
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='notificationsetting',
            index=models.Index(
                fields=['type', 'organization'], name='immunity_no_type_5a6a77_idx'
            ),
        ),
